...
```
- Log into the [Azure Portal](https://portal.azure.com/), and find your newly created webapp. Click the "Deployment center" select "Local git" and "Kudu build". Click "Finish" and copy the "git clone url". Add the URL as a remote git repository and push your code to the `master` branch on Azure:
